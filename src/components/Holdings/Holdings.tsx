              ...
              <table className="min-w-full divide-y">
                <thead className="">
                  <tr>
                    ...
                    >
                      <div className="w-5 h-5 bg-gray-300 ml-2"></div>
                    </th>
                    <th
                      scope="col"
                      className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td className="px-4 whitespace-nowrap">
                      <div className="font-light">ABNB</div>
                    </td>
                    <td className="px-4 whitespace-nowrap">
                      <span className="font-light">11.19</span>
                    </td>
                    <td className="px-4 whitespace-nowrap">
                      <div className="font-light">$134.09</div>
                    </td>
                    <td className="px-4 whitespace-nowrap">
                      <div className="font-light">$140.40</div>
                    </td>
                    <td className="px-4 whitespace-nowrap">
                      <div className="font-light">$1,570.64</div>
                    </td>
                    <td className="px-4 whitespace-nowrap">
